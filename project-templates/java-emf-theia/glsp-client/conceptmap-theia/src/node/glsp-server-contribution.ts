...
export const PORT_ARG_KEY = 'CONCEPTMAP_GLSP';
...
@injectable()
export class ConceptMapLanguageGLSPServerContribution extends GLSPSocketServerContribution {
    readonly id = ConceptMapLanguage.contributionId;
