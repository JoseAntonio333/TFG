...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Specializes</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.glsp.conceptap.model.impl.SpecializesImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link org.eclipse.glsp.conceptap.model.impl.SpecializesImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link org.eclipse.glsp.conceptap.model.impl.SpecializesImpl#getImportedOrigin <em>Imported Origin</em>}</li>
 *   <li>{@link org.eclipse.glsp.conceptap.model.impl.SpecializesImpl#getImportedDestination <em>Imported Destination</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecializesImpl extends IdentifiableImpl implements Specializes {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SPECIALIZES;
	}
		...
		if (origin != null && origin.eIsProxy()) {
			...
			if (origin != oldOrigin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.SPECIALIZES__ORIGIN,
							oldOrigin, origin));
			}
		}
		return origin;
	...
	public void setOrigin(Concept newOrigin) {
		...
		origin = newOrigin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SPECIALIZES__ORIGIN, oldOrigin, origin));
	}
	...
	public Concept getDestination() {
		if (destination != null && destination.eIsProxy()) {
			...
			if (destination != oldDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.SPECIALIZES__DESTINATION,
	...
	public void setDestination(Concept newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SPECIALIZES__DESTINATION, oldDestination,
					destination));
	}
	...
	public Imported_Concept getImportedOrigin() {
		if (importedOrigin != null && importedOrigin.eIsProxy()) {
			...
			if (importedOrigin != oldImportedOrigin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.SPECIALIZES__IMPORTED_ORIGIN,
	...
	public void setImportedOrigin(Imported_Concept newImportedOrigin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SPECIALIZES__IMPORTED_ORIGIN,
					oldImportedOrigin, importedOrigin));
	}
			...
			if (importedDestination != oldImportedDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModelPackage.SPECIALIZES__IMPORTED_DESTINATION, oldImportedDestination,
							importedDestination));
			}
		}
	...
	public void setImportedDestination(Imported_Concept newImportedDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SPECIALIZES__IMPORTED_DESTINATION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModelPackage.SPECIALIZES__ORIGIN:
			if (resolve)
				return getOrigin();
			return basicGetOrigin();
		case ModelPackage.SPECIALIZES__DESTINATION:
			if (resolve)
				return getDestination();
			return basicGetDestination();
		case ModelPackage.SPECIALIZES__IMPORTED_ORIGIN:
			if (resolve)
				return getImportedOrigin();
			return basicGetImportedOrigin();
		case ModelPackage.SPECIALIZES__IMPORTED_DESTINATION:
			if (resolve)
