...
import {ConceptMapUsesEdgeView, ConceptMapUsesTopicEdgeView, ConceptMapSpecializesEdgeView, TopicNodeView, CaptionNodeView } from './views';
import { CourseNode } from './model';
//import { CourseNode } from './model';
...
const conceptMapDiagramModule = new ContainerModule((bind, unbind, isBound, rebind) => {
    ...
    configureModelElement(context, CustomTypes.IMPORTED_CONCEPT_ANNOTATIONS, GLabel, GLabelView, { enable: [editLabelFeature] });
    ...
    configureModelElement(context, CustomTypes.CONCEPT, GNode, RoundedCornerNodeView);
    ...
    configureModelElement(context, CustomTypes.FEATURE, GCompartment, GCompartmentView);
