...
public class CreateAfterEdgeHandler extends EMFCreateOperationHandler<CreateEdgeOperation>{
            ...
            for(Course course: courses){
                ...
                for(Topic topic: topics){
                    ...
                    if(topic.getId().equals(source)){
                        ...
                        after.setOrigin(findTopicById(source, conceptMap));
                        after.setDestination(findTopicById(target, conceptMap));
    ...
    protected Topic findTopicById(final String topicId, final ConceptMap conceptMap) {
        List<Course> courses = conceptMap.getCourse();
