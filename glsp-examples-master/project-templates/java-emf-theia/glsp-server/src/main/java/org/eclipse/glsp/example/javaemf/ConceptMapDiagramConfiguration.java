...
public class ConceptMapDiagramConfiguration extends BaseDiagramConfiguration {
   ...
   public List<ShapeTypeHint> getShapeTypeHints() {
      ...
      List<ShapeTypeHint> hints = new ArrayList<>();
		hints.add(new ShapeTypeHint(DefaultTypes.GRAPH, true, true, true, true,
				List.of(ConceptMapModelTypes.COURSE, ConceptMapModelTypes.TOPIC, ConceptMapModelTypes.PROPERTIES, ConceptMapModelTypes.CONCEPT, 
            ConceptMapModelTypes.IMPORTED_CONCEPT,ConceptMapModelTypes.LEGEND,ConceptMapModelTypes.FEATURE)));
		...
		hints.add(new ShapeTypeHint(ConceptMapModelTypes.CONCEPT, true, true, true, true, List.of(ConceptMapModelTypes.FEATURE)));
		hints.add(new ShapeTypeHint(ConceptMapModelTypes.IMPORTED_CONCEPT, true, true, true, true));
		hints.add(new ShapeTypeHint(ConceptMapModelTypes.LEGEND, false, false, false, true));
		hints.add(new ShapeTypeHint(ConceptMapModelTypes.PROPERTIES, false, false, false, true));
      hints.add(new ShapeTypeHint(ConceptMapModelTypes.FEATURE, true, true, false, true));
		return hints;
   }
   ...
   public Map<String, EClass> getTypeMappings() {
      ...
      mapping.put(ConceptMapModelTypes.FEATURE, GraphPackage.Literals.GNODE);
      ...
      mapping.put(ConceptMapModelTypes.IMPORTED_CONCEPT_ANNOTATIONS, GraphPackage.Literals.GLABEL);
   ...
   public List<EdgeTypeHint> getEdgeTypeHints() {
      ...
      return List.of(
        new EdgeTypeHint(ConceptMapModelTypes.USES, true, true, true, true, 
            List.of(ConceptMapModelTypes.CONCEPT, ConceptMapModelTypes.IMPORTED_CONCEPT),  List.of(ConceptMapModelTypes.CONCEPT, ConceptMapModelTypes.IMPORTED_CONCEPT)),
        new EdgeTypeHint(ConceptMapModelTypes.AFTER, true, true, true, true,List.of(ConceptMapModelTypes.TOPIC),  List.of(ConceptMapModelTypes.TOPIC)),
        new EdgeTypeHint(ConceptMapModelTypes.SPECIALIZES, true, true, true, true, List.of(ConceptMapModelTypes.CONCEPT, ConceptMapModelTypes.IMPORTED_CONCEPT),  List.of(ConceptMapModelTypes.CONCEPT, ConceptMapModelTypes.IMPORTED_CONCEPT)));
