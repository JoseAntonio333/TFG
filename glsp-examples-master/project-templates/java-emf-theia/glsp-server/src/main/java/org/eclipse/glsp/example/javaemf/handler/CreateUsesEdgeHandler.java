                    ...
                    for(Topic topic: topics){
                        ...
                        for(Imported_Concept imported: importeds){
                            ...
                            if(imported.getId().equals(source)){
                                uses.setImportedOrigin(findImportedConceptById(source, conceptMap));
                                uses.setOrigin(null);
                                if(imported_destination == true){
                                    uses.setImportedDestination(findImportedConceptById(target, conceptMap));
                                    uses.setDestination(findConceptById(target, conceptMap));
                                }else{
                                    uses.setDestination(findConceptById(target, conceptMap));
                                    uses.setImportedDestination(findImportedConceptById(target, conceptMap));
                                }
                ...
                for(Topic topic: topics){
                    ...
                    for(Concept concept: concepts){
                        ...
                        if(concept.getId().equals(source)){
                            uses.setOrigin(findConceptById(source, conceptMap));
