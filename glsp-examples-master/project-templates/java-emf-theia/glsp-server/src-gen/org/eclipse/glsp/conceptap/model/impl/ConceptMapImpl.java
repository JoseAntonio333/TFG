 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.glsp.conceptap.model.impl.ConceptMapImpl#getCourse <em>Course</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConceptMapImpl extends IdentifiableImpl implements ConceptMap {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CONCEPT_MAP;
	}
	...
	public EList<Course> getCourse() {
		if (course == null) {
			course = new EObjectContainmentEList<Course>(Course.class, this, ModelPackage.CONCEPT_MAP__COURSE);
		}
		return course;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ModelPackage.CONCEPT_MAP__COURSE:
